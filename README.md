...
>This is a fixed fork of the generated Swagger [go client](https://github.com/grafeas/client-go), adapted to follow the OpenApi specification as recorded
>[here](https://github.com/grafeas/client-go/issues/13)
